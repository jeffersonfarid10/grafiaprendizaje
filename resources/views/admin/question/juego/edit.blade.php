    ...
    <div class="card-body">
        <form action="{{route('admin.question.juego.update', $juego)}}" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                @for($j=0; $j<(10 - count($juego->indications)); $j++)
                    <input type="text" name="indicacionesedit[]" class="form-control" placeholder="Indicación {{count($juego->indications)+$j+1}}" value="{{old('indication')}}">
                    <br>
                @endfor
            ...
            <div class="form-group">
                ...
                @for($k=0; $k<(10 - count($juego->justifications)); $k++)
                    <input type="text" name="justificacionesedit[]" class="form-control" placeholder="Justificación {{count($juego->justifications)+$k+1}}" value="{{old('reason')}}">
                    <input type="text" name="reglasedit[]" class="form-control" placeholder="Clasificación {{count($juego->justifications)+$k+1}}" value="{{old('rule')}}">
                    <br>
                @endfor
