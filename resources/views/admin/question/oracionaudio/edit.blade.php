    ...
    <div class="card-body">
        <form action="{{route('admin.question.oracionaudio.update', $oracionaudio)}}" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                @for($j=0; $j<(10 - count($oracionaudio->indications)); $j++)
                    <input type="text" name="indicacionesedit[]" class="form-control" placeholder="Indicación {{count($oracionaudio->indications)+$j+1}}" value="{{old('indication')}}">
                    <br>
                @endfor
            ...
            <div class="form-group">
                ...
                @for($k=0; $k<(10 - count($oracionaudio->justifications)); $k++)
                    <input type="text" name="justificacionesedit[]" class="form-control" placeholder="Justificación {{count($oracionaudio->justifications)+$k+1}}" value="{{old('reason')}}">
                    <input type="text" name="reglasedit[]" class="form-control" placeholder="Clasificación {{count($oracionaudio->justifications)+$k+1}}" value="{{old('rule')}}">
                    <br>
                @endfor
