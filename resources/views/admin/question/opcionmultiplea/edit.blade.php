    ...
    <div class="card-body">
        <form action="{{route('admin.question.opcionmultiplea.update', $opcionmultiplea)}}" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <br>
                <!-- AGREGAR LOS CAMPOS VACIOS DE LOS 10 TOTALES POR SI EL USUARIO DESEA AGREGAR O QUITAR INDICACIONES AL MOMENTO DE EDITAR -->
                @for($j=0; $j<(10 - count($opcionmultiplea->indications)); $j++)
                    <input type="text" name="indicacionesedit[]" class="form-control" placeholder="Indicación {{count($opcionmultiplea->indications)+$j+1}}" value="{{old('indication')}}">
                    <br>
                @endfor
            ...
            <div class="form-group">
                ...
                @for($k=0; $k<(10 - count($opcionmultiplea->justifications)); $k++)
                    <input type="text" name="justificacionesedit[]" class="form-control" placeholder="Justificación {{count($opcionmultiplea->justifications)+$k+1}}" value="{{old('reason')}}">
                    <input type="text" name="reglasedit[]" class="form-control" placeholder="Clasificación {{count($opcionmultiplea->justifications)+$k+1}}" value="{{old('rule')}}">
                    <br>
                @endfor
