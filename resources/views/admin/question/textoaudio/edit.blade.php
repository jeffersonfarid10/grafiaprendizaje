    ...
    <div class="card-body">
        <form action="{{route('admin.question.textoaudio.update', $textoaudio)}}" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                @for($j=0; $j<(10 - count($textoaudio->indications)); $j++)
                    <input type="text" name="indicacionesedit[]" class="form-control" placeholder="Indicación {{count($textoaudio->indications)+$j+1}}" value="{{old('indication')}}">
                    <br>
                @endfor
