    ...
    <div class="card-body">
        <form action="{{route('admin.question.oracionimagen.update', $oracionimagen)}}" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                @for($j=0; $j<(10 - count($oracionimagen->indications)); $j++)
                    <input type="text" name="indicacionesedit[]" class="form-control" placeholder="Indicación {{count($oracionimagen->indications)+$j+1}}" value="{{old('indication')}}">
                    <br>
                @endfor
