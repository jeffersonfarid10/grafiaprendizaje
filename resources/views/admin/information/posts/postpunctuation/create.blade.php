...
@section('content_header')
    <h1 class="text-danger"><strong>Crear regla ortográfica de puntuación nivel tres</strong></h1>
@stop
                        ...
                        <div class="col">
                            <div class="image-wrapper">
                                ...
                                @else 
                                    ...
                                    <img id="picture" src="/imagenesapp/imagenformulario.png" alt="" class="border">
                                @endisset
                            </div>
                        </div>
                        <div class="col">
