           ...
           <!-- AQUI SE MUESTRAN LAS PALABRAS ENCONTRADAS -->
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 divide-x divide-gray-300 rounded" >
                ...
                <div class="col-span-1 ml-10 mb-10">
                    <h5 class="font-bold font-sora text-red-500 mt-4 ml-4 mb-5 text-lg">Cada ítem posee una palabra escrita incorrectamente o incompleta, encuentre las palabras correctas en la sopa de letras:</h5>
                    <div>
